# Finish Render deploy (2 minutes)

GitHub is ready. Complete these steps in the browser tab that opened (or go to [Render Blueprint](https://dashboard.render.com/blueprint/new)).
